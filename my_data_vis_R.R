...
plot(cyl ~ hp, data = mtcars,
     col='Cylindars') #dependent variable ~ independent variable, data = your DF
...
#
boxplot( wt ~ carb, data = mtcars,
main = 'Effect of carbs and weight', #title
xlab = 'Carbs', #x-axis label
...
myplot2 +
  ...
  labs(title = 'Effects of horsepower on MPG by cylinder', #title
...
ggsave(myplot3, #plot to be saved
